...
class ClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class" do
    assert_difference('Classe.count') do
      post classes_url, params: { class: { designation: @class.designation, level_id: @class.level_id } }
    end
  ...
  test "should update class" do
    patch class_url(@class), params: { class: { designation: @class.designation, level_id: @class.level_id } }
