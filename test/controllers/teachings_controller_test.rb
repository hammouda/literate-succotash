...
class TeachingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teaching" do
    assert_difference('Teaching.count') do
      post teachings_url, params: { teaching: { classe_id: @teaching.classe_id, teacher_id: @teaching.teacher_id, year: @teaching.year } }
    end
  ...
  test "should update teaching" do
    patch teaching_url(@teaching), params: { teaching: { classe_id: @teaching.classe_id, teacher_id: @teaching.teacher_id, year: @teaching.year } }
