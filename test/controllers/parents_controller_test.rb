...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { first_name: @parent.first_name, group_id: @parent.group_id, id: @parent.id, last_name: @parent.last_name, phone: @parent.phone } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { first_name: @parent.first_name, group_id: @parent.group_id, id: @parent.id, last_name: @parent.last_name, phone: @parent.phone } }
